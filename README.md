...
(5x5)** to evaluate models under four scenarios. To \
ensure robustness, we trained and
tuned four classifiers (RF, XGB, LR, KNN) using **RandomizedSearchCV**.
...
Random Forest was the highest performing classifier. Augmenting the small real
dataset with **50% synthetic
data** generated by a
