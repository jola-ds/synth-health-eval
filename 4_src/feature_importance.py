...
def run_shap_analysis():
    ...
    if isinstance(shap_values, list):
        ...
        print(f"DEBUG: SHAP output is 3D Array. Selecting Class 1.")
    ...
    plt.title("Feature Importance & Directionality (SHAP - Class: Hypertension)", fontsize=24, pad=20)
    ...
    for _, row in importance_df.iterrows():
        ...
        try:
             ...
             if abs(corr) < 0.1: direction = "Non-linear/Null"
